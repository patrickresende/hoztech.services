// Verifica se o NavbarManager já existe antes de criar uma nova instância
if (typeof window.navbarManager === 'undefined') {
    class NavbarManager {
        constructor() {
    ...
    // Inicializa o NavbarManager apenas se ainda não existir
